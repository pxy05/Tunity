      ...
      <div class="pinterest-grid">
        ...
        <div class="glass-card p-6 rounded-lg hover-expand-card card-glint">
          ...
          <div class="flex items-center justify-between">
            ...
            <button class="glass-light px-3 py-1 rounded text-xs">Save</button>
          </div>
        </div>
        ...
        <div class="glass-card p-6 rounded-lg hover-expand-card">
          ...
          <div class="flex items-center justify-between">
            <span class="text-xs text-gray-300">2 weeks ago</span>
            <button class="glass-light px-3 py-1 rounded text-xs">Save</button>
          </div>
        </div>
...
/* Enhanced hover effects for Pinterest cards */
.hover-expand-card {
